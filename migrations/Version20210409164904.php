 ...
 */
final class Version20210409164904 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE delivery_address.hr.yaml CHANGE user_id user_id INT DEFAULT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE delivery_address.hr.yaml CHANGE user_id user_id INT NOT NULL');
    }
}
